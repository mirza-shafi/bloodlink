 ...
 * Demonstrates OOP: Uses composition for security filter chain.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/donors/search").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Cannot use wildcard "*" with allowCredentials=true
